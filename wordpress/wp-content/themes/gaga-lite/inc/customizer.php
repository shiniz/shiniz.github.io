...
function gaga_lite_customize_register( $wp_customize ) {
    ...
    */
    ...
    $wp_customize->register_section_type( 'Gaga_Lite_Customize_Section_Pro' );

    // Register sections.
    $wp_customize->add_section(
        new Gaga_Lite_Customize_Section_Pro(
            $wp_customize,
            'gaga-pro',
            array(
                'title'    => esc_html__( 'Upgrade To Gaga Pro', 'gaga-lite' ),
                'title1'    => esc_html__( 'Free Vs Pro', 'gaga-lite' ),
                'pro_text' => esc_html__( 'Buy Now','gaga-lite' ),
                'pro_text1' => esc_html__( 'Compare','gaga-lite' ),
                'pro_url'  => 'https://accesspressthemes.com/wordpress-themes/gaga-pro/',
                'pro_url1'  => admin_url( 'themes.php?page=gagalite-welcome&section=free_vs_pro'),
                'priority' => 1,
            )
        )
    );
