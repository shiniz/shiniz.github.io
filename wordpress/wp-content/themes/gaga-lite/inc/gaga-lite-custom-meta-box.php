        ...
        <tr>
            ...
            <?php  
               foreach ($gaga_lite_sidebar_layout as $field) {  
                            ...
                            <input type="radio" name="gaga_lite_sidebar_layout" value="<?php echo esc_attr($field['value']); ?>" <?php checked( $field['value'], $gaga_lite_sidebar_metalayout ); if(empty($gaga_lite_sidebar_metalayout) && $field['value']=='right-sidebar'){ echo "checked='checked'";} ?>/>&nbsp;<?php echo esc_html($field['label']); ?>
                            </label>
                            </div>
                    <?php } // end foreach ?>
                    <div class="clear"></div>
