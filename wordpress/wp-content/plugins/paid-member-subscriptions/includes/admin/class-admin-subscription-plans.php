	...
	public static function manage_posts_custom_column( $column, $post_id ) {
        ...
        if( $column == 'price' ) {
            ...
            if( $subscription_plan->price == 0 )
                ...
                echo pms_format_price( $subscription_plan->price, $pms_settings['payments']['currency'] ) . $duration;
        ...
        if( $column == 'sign_up_fee' ) {
            ...
            if( $subscription_plan->sign_up_fee == 0 )
                ...
                echo pms_format_price( $subscription_plan->sign_up_fee, $pms_settings['payments']['currency'] );
